...
def generate_dropdowns_data():
    ...
    s_periodos = df['cod_periodo'].drop_duplicates()
    s_periodos.index = [
    ...
    s_territorial = df['direccion_territorial'].drop_duplicates()
    s_territorial.index = s_territorial

    s_cetap = df['cetap'].drop_duplicates()
    s_cetap.index = s_cetap

    s_modalidad = df['modalidad'].drop_duplicates()
    s_modalidad.index = s_modalidad

    s_metodologia = df['metodologia'].drop_duplicates()
    s_metodologia.index = s_metodologia

    s_programa = df['programa'].drop_duplicates()
